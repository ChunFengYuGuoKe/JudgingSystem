...
> 请求路径：/homework/{lang}/{id_homework}
>
> 请求方式：GET
>
...
| 名称        | 类型   | 是否必须 | 备注                  |
| ----------- | ------ | -------- | --------------------- |
| id_class    | String | 必须     | 班级号(课程号-课序号) |
| studentList | file   | 必须     | 学生名单电子表格      |
...
> 请求路径：/submits/details/{id_submit}
>
> 请求方式：GET
>
> 接口描述：获取提交结果 
...
> 请求路径：/submits/records/{id_homework}
>
> 请求方式：GET
>
...
> 请求路径：/submits/rank/{id_class}
>
> 请求方式：GET
>
> 接口描述：获取某班级的学生总分排行榜（降序） 
...
| 名称     | 类型 | 是否必须 | 备注                                                         |
| -------- | ---- | -------- | ------------------------------------------------------------ |
| id_class | int  | 必须     | 班级号 0查看学生当前班级排名（学生），否则查看特定班级排名（教师） |
